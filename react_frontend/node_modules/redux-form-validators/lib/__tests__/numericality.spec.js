...
describe('Validator: numericality', function () {
  ...
  it('should use formatMessage', function () {
    ...
    _assert2.default.equal(ERROR_NOT_A_NUMBER_ID + '2', test('foobar'));
    _assert2.default.equal(ERROR_EQUAL_TO_ID + '2', test(1, { '=': 0 }));
    _assert2.default.equal(ERROR_OTHER_THAN_ID + '2', test(1, { '!=': 1 }));
    _assert2.default.equal(ERROR_GREATER_THAN_ID + '2', test(-1, { '>': 0 }));
    _assert2.default.equal(ERROR_GREATER_THAN_OR_EQ_ID + '2', test(-1, { '>=': 0 }));
    _assert2.default.equal(ERROR_LESS_THAN_ID + '2', test(1, { '<': 0 }));
    _assert2.default.equal(ERROR_LESS_THAN_OR_EQ_ID + '2', test(1, { '<=': 0 }));
    _assert2.default.equal(ERROR_EVEN_ID + '2', test('1', { even: true }));
    _assert2.default.equal(ERROR_ODD_ID + '2', test('2', { odd: true }));
