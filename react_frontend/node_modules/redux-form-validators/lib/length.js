...
var length = (0, _helpers.memoize)(function (_ref) {
  ...
  return (0, _helpers.prepare)(ifCond, unless, allowBlank, function (value) {
    if ((0, _helpers.isNumber)(equal) && value.length !== +equal) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'wrongLength', { count: equal }));
    }
    if ((0, _helpers.isNumber)(max) && value.length > +max) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'tooLong', { count: max }));
    }
    if ((0, _helpers.isNumber)(min) && value.length < +min) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'tooShort', { count: min }));
    }
  });
});
