...
function inclusionExclusion(inclusion, _ref) {
  ...
  return (0, _helpers.prepare)(ifCond, unless, allowBlank, function (value) {
    var cs = null != caseSensitive ? caseSensitive : _index2.default.defaultOptions.caseSensitive;
    var array = within;
    ...
    if (inclusion) {
      if (array.indexOf(value) < 0) {
        return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'inclusion'));
      }
    } else {
      if (array.indexOf(value) >= 0) {
        return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'exclusion'));
      }
    }
  });
}