...
var date = (0, _helpers.memoize)(function () {
  ...
  return (0, _helpers.prepare)(ifCond, unless, allowBlank, function (value) {
    ...
    if ('wrongFormat' === date) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'dateFormat', { format: format }));
    }
    if ('invalid' === date) {
      return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'dateInvalid'));
    }
    if (date) {
      var date2 = void 0;
      if (eq && +date !== +(date2 = getDate(eq))) {
        return _index2.default.formatMessage((0, _helpers.prepareMsg)(msg, 'dateRange', values('=', date2, normFormat)));
      }
...
function normalizeFormat(format, ymd) {
  ...
  if (null == format) {
    format = _index2.default.defaultOptions.dateFormat;
  }
  if (!ymd) {
    ymd = _index2.default.defaultOptions.dateYmd;
  }
  if (!ymd || 'ymd' === ymd) {
    return format;
  }
