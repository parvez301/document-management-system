...
<html lang="en">
<head>
    <title>Code coverage report for src/date.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> date.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>88/89</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">100% </span>
...
<span class="cline-any cline-yes">8×</span>
<span class="cline-any cline-yes">8×</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import Validators from './index'
...
function currentCentury (add) {
  ...
  return c</span>entury &lt; 0 ? <span class="branch-0 cbranch-no" title="branch not covered" >century - add : century + add
}</pre></td></tr>
</table></pre>
