...
<html lang="en">
<head>
    <title>Code coverage report for src/__tests__/memoize.spec.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/__tests__/</a> memoize.spec.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y'>
        <span class="strong">5 statements, 5 functions, 1 branch</span>
...
<span class="fstat-skip" title="function not covered" >    function(options, value) {</span> <span class="cstat-skip" title="statement not covered" >r</span>eturn value === 'foo' }
})
&nbsp;
describe('memoize', function () {
  it('should return the same function when the options are the same', function() {
    ...
    assert.ok(test(absence, { if:
      /* istanbul ignore next */
<span class="fstat-skip" title="function not covered" >      (value, values) =&gt; {</span> <span class="cstat-skip" title="statement not covered" >r</span>eturn '' !== values.name }
    }))
...
&nbsp;
    ...
    assert.ok(test(date, { format: 'jj/mm/aaaa', ymd: 'amj', '&lt;=':
      /* istanbul ignore next */
<span class="fstat-skip" title="function not covered" >      function() {</span> <span class="cstat-skip" title="statement not covered" >r</span>eturn new Date() }
    }))
...
&nbsp;
    ...
    assert.ok(test(fooValidator, { if:
      /* istanbul ignore next */
<span class="fstat-skip" title="function not covered" >      (value, values) =&gt; {</span> <span class="cstat-skip" title="statement not covered" >r</span>eturn false }
    }))
  })
})
&nbsp;</pre></td></tr>
